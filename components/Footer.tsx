      ...
      <div className="max-w-screen-xl mx-auto px-4 md:px-8">
        ...
        <div className="flex-1 mt-16 space-y-6 justify-between sm:flex md:space-y-0">
          ...
          <ul className="space-y-4 text-gray-300">
            ...
            <li>
              <a href="https://wa.me/971509786080" className="duration-150 hover:text-gray-400">WhatsApp</a>
            </li>
          </ul>
        </div>
        <div className="mt-10 py-10 border-t border-gray-700 items-center justify-between sm:flex">
          ...
          <div className="flex items-center gap-x-6 text-gray-400 mt-6 sm:mt-0">
            ...
            <a href="https://wa.me/971509786080">
            <svg style={{ width: '150px', height: '100px',marginTop:'35%',marginLeft:"-20%" }} className="hover:text-gray-500 duration-150" fill="none" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
